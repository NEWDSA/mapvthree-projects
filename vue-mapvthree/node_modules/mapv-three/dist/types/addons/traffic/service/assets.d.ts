...
export function deleteDevice(uuid: any): Promise<any>;
...
export function checkAuth(params: any, host: any): Promise<any>;
export function connectDeviceActiveInfo(host: any): Promise<{
    ws: Ws;
    connect: any;
}>;
